...
| V-027 | 로컬 관찰용 데이터 흐름은 10초짜리 원본 replay가 아니며 여러 실행/RPM 변화를 제공한다 | VERIFIED | Canonical checksum `aee293...9b17f`, source range `2016-10-05T09:18:27.292Z`—`10:18:22.999Z`에서 path execution/spindle RPM 337건 선택을 unit test로 고정. `run-local`은 1.5초 관찰용 간격으로 약 8분 발행하며 원본 timing이 아님을 콘솔/README에 명시 | 15 | 2026-09-03 |
| V-028 | Step 01~15의 NIST Operational Twin과 2D/3D visual 의미는 Process Analytics 경계 추가 후에도 유지된다 | VERIFIED | Regression manifest `078156...2085`가 Twin `6f22dc...e9b3`, patch `59df38...84f6`, E2E scenario `bc993c...3863`과 Canonical output `aee293...9b17f`를 고정한다. `./scripts/verify`, `./scripts/verify-database`, `./scripts/verify-e2e` 통과. [ADR-032](./adr/ADR-032-observed-process-analytics-boundary.md) | 16 | 2026-09-03 |
